...
namespace ZeiHomeKitchen_backend.Migrations
{
    ...
    [Migration("20250410122140_IgnoreReservationModelStatistique")]
    partial class IgnoreReservationModelStatistique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Models.Ingredient", b =>
                {
                    b.Property<int>("IdIngredient")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Models.Plat", b =>
                {
                    b.Property<int>("IdPlat")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Models.Statistique", b =>
                {
                    b.Property<int>("IdStatistique")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Models.Utilisateur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ZeiHomeKitchen_backend.Models.Utilisateur", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlatIngredient", b =>
                {
                    b.HasOne("ZeiHomeKitchen_backend.Models.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("IdIngredient")
                        .IsRequired()
                        .HasConstraintName("FK__Plat_Ingr__id_in__4F7CD00D");

                    b.HasOne("ZeiHomeKitchen_backend.Models.Plat", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlatReservation", b =>
                {
                    ...
                    b.HasOne("ZeiHomeKitchen_backend.Models.Reservation", null)
                        .WithMany()
