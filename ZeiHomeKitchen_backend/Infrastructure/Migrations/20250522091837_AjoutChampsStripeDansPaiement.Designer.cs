...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Ingredient", b =>
                {
                    b.Property<int>("IdIngredient")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Paiement", b =>
                {
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Plat", b =>
                {
                    b.Property<int>("IdPlat")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Reservation", b =>
                {
                    b.Property<int>("IdReservation")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Statistique", b =>
                {
                    b.Property<int>("IdStatistique")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Utilisateur", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Utilisateur", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlatIngredient", b =>
                {
                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Ingredient", null)
                        .WithMany()
                        .HasForeignKey("IdIngredient")
                        .IsRequired()
                        .HasConstraintName("FK__Plat_Ingr__id_in__4F7CD00D");

                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Plat", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PlatReservation", b =>
                {
                    ...
                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Reservation", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Paiement", b =>
                {
                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Reservation", "ReservationNavigation")
                        .WithOne("Paiement")
                        .HasForeignKey("ZeiHomeKitchen_backend.Domain.Models.Paiement", "IdReservation")
                        .IsRequired()
            ...
            modelBuilder.Entity("ZeiHomeKitchen_backend.Domain.Models.Reservation", b =>
                {
                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Statistique", "StatistiqueNavigation")
                        .WithMany("Reservations")
                        .HasForeignKey("IdStatistique")
                        .HasConstraintName("FK__Reservati__id_st__412EB0B6");

                    b.HasOne("ZeiHomeKitchen_backend.Domain.Models.Utilisateur", "UtilisateurNavigation")
                        .WithMany("Reservations")
