...
namespace ZeiHomeKichen_backend.Tests;

public class IngredientServiceTests
{
    private readonly Mock<IIngredientRepository> _mockIIngredientRepository;
    ...
    public IngredientServiceTests()
    {
        ...
        _mockIIngredientRepository = new Mock<IIngredientRepository>();
        _mockMapper = new Mock<IMapper>();
        _ingredientService = new IngredientService(_mockIIngredientRepository.Object, _mockMapper.Object, _mockLogger.Object);
    }
    ...
    public async Task TestGetIngredients()
    {
        ...
        _mockIIngredientRepository.Setup(repo => repo.GetIngredients())
    ...
    public async Task TestGetIngredient()
    {
        ...
        _mockIIngredientRepository.Setup(repo => repo.GetIngredient(1))
    ...
    public async Task TestDeleteIngredient()
    {
        ...
        _mockIIngredientRepository.Setup(repo => repo.GetIngredient(ingredientId))
               .ReturnsAsync(ingredient);

        //Utilisation de mock pour supprimer cet ingrédient 
        _mockIIngredientRepository.Setup(repo => repo.DeleteIngredient(ingredientId))
               .ReturnsAsync(true);
        ...
        _mockIIngredientRepository.Verify(repo => repo.DeleteIngredient(1), Times.Once);
    ...
    public async Task TestCreateIngredient()
    {
        ...
        _mockIIngredientRepository.Setup(repo => repo.CreateIngredient(It.IsAny<Ingredient>()))
        ...
        _mockIIngredientRepository.Verify(repo => repo.CreateIngredient(It.IsAny<Ingredient>()), Times.Once);
    ...
    public async Task TestUpdateIngredient()
    {
        ...
        // Utilisation du mock pour retourner l'entité lors de la création
        _mockIIngredientRepository.Setup(repo => repo.UpdateIngredient(It.IsAny<Ingredient>()))
            .ReturnsAsync(ingredientEntity);
